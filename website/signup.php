...
<html lang="en">
    <head>
        ...
        <title>Signup | Ecommerce Store</title>
                ...
                <div class="container">
                    <div class="col-lg-4 col-lg-offset-3 col-md-6">
                        ...
                        <form  action="signup_script.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control"  placeholder="Contact (ex. +254758312202)" maxlength="12" size="12" name="contact" required = "true"><?php if(isset($_GET['m2'])) echo $_GET['m2']; ?>
                            </div><br><br>
                            <div class="form-group">
